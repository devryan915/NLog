...
- [#2662](https://github.com/nlog/nlog/pull/2662) FileTarget - Improve handling of archive with multiple active files (@snakefoot)
- [#2651](https://github.com/nlog/nlog/pull/2651) GetNLogExtensionFiles should handle DirectoryNotFoundException (@snakefoot)
